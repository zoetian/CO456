...
public class Parameters {
  ...
  //Payoff table at the game's end. Tie is when both players won, draw is when the move limit MAX_NUM_MOVES is reached.
  ...
  //Number of rounds in a tournament, followed by a geometric distribution with probability 1/2
  public static int MIN_NUM_DIFFERENT_BOARDS = 18;
  
  //public static final boolean PRINT_LOG = true;
  public static final boolean PRINT_LOG = false;
  
  //Rough time limits for each player's constructor, etc. during a tournament.
