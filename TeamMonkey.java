  ...
  public MoveDescription chooseMove() {
    ...
    if (theirKingIsAlive) {
      for (MoveDescription moveDescription : allPossibleMoves) {
        if (moveDescription.getDestinationColumn() == theirKingColumn && moveDescription.getDestinationRow() == theirKingRow) {
    ...
    if (theirRookIsAlive) {
      for (MoveDescription moveDescription : allPossibleMoves) {
        if (moveDescription.getDestinationColumn() == theirRookColumn && moveDescription.getDestinationRow() == theirRookRow) {
          return moveDescription;
        }
      }
    }
